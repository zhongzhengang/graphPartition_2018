...
public class TestPR  implements Tool  {
	private Configuration conf;
	public static String filePath = "NotreDame_random.txt";
	public static String outputPath = "pr";
	
	public static void main(String[] args) throws Exception {
		 PropertyConfigurator.configure("D:/config/log4j.properties");
		ToolRunner.run(new TestPR(), args);
}
	...
	public int run(String[] args) throws Exception {
  	...
  	// 初始化config
		...
		// 配置计算类
		giraphConf.setComputationClass(D_PageRank.class);
...
//		"com.cat.app.NewPartitionerFactory");
