...
import edu.xdu.psy.gplp.GPLP_alpha.ConverterPropagate;
import edu.xdu.psy.gplp.GPLP_alpha.PartitionerMasterCompute;
import edu.xdu.psy.gplp.custom.GPLPEdgeInputFormat;
import edu.xdu.psy.gplp.custom.OpenHashMapEdges;

public class Test_GPLP_alpha implements Tool {

	//Gowalla_edges k=32 Edge Cut Rate (%)=43 Balance Rate (x1000)=1046 Total (ms)=231752
	
	private Configuration conf;
	public static String filePath = "/tmp/Gowalla_edges.txt";
	public static String outPath = "/tmp/out";

	public static void main(String[] args) throws Exception {
		 PropertyConfigurator.configure("/home/hduser/workspace/config/log4j.properties");
			ToolRunner.run(new Test_GPLP_alpha(), args);
	}
